...
# Open a workbook 
workbook = xlrd.open_workbook(filename + "_Fd" + ".xls")
# Loads only current sheets to memory
workbook = xlrd.open_workbook(filename + "_Fd" + ".xls", on_demand = True)
...
animation.save(filename + "_Fd" + '.gif', writer = 'imagemagick')